	  <!-- LayerSlider start -->
      <div id="layerslider" style="width: 100%; height: 390px; margin: 0 auto;">

        <!-- slide one start -->
        <div class="ls-slide ls-slide1" data-ls="offsetxin: right; slidedelay: 4000;">
        ...
        <!-- slide two start -->
        <div class="ls-slide ls-slide2" data-ls="offsetxin: right; slidedelay: 4000; transition2d: 110,111,112,113;">
